...
def to_dict(
    ...
    Example:
        ...
        >>> from provenance.utils.serialization import to_dict
...
def to_json(
    ...
    **json_kwargs: Any,
    ...
    Example:
        >>> from provenance import load_yaml
        >>> from provenance.utils.serialization import to_json
        >>> config = load_yaml("config.yaml")
...
def to_json_file(
    ...
    **json_kwargs: Any,
    ...
    Example:
        >>> from provenance import load_yaml
        >>> from provenance.utils.serialization import to_json_file
        >>> config = load_yaml("config.yaml")
...
def from_dict(
    ...
    Example:
        >>> from provenance.utils.serialization import from_dict
        >>> data = {"key": "value"}
...
def from_json(json_str: str, with_provenance: bool = False) -> Any:
    ...
    Example:
        >>> from provenance.utils.serialization import from_json
        >>> json_str = '{"key": "value"}'
...
def from_json_file(file_path: Union[str, Path], with_provenance: bool = False) -> Any:
    ...
    Example:
        >>> from provenance.utils.serialization import from_json_file
...
def dict_to_provenance(data: list[dict[str, Any]]) -> Any:
    ...
    Example:
        >>> from provenance.utils.serialization import dict_to_provenance
...
def serialize_for_display(
    ...
    Example:
        >>> from provenance import load_yaml
        >>> from provenance.utils.serialization import serialize_for_display
        >>> config = load_yaml("config.yaml")

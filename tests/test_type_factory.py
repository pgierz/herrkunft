...
from provenance.core.provenance import Provenance
from provenance.types.base import HasProvenance
from provenance.types.factory import TypeWrapperFactory, wrap_with_provenance
from provenance.types.wrappers import (
    BoolWithProvenance,
    IntWithProvenance,
    NoneWithProvenance,
    StrWithProvenance,
...
class TestWrapWithProvenanceFunction:
    ...
    def test_import_from_types_module(self):
        ...
        from provenance.types import wrap_with_provenance as wrap

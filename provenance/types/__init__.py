...
Usage:
    >>> from provenance.types import wrap_with_provenance
...
from provenance.types.base import (
    HasProvenance,
    ProvenanceMixin,
    ProvenanceWrapper,
)
from provenance.types.factory import (
    TypeWrapperFactory,
    wrap_with_provenance,
)
from provenance.types.mappings import (
    DictWithProvenance,
    ListWithProvenance,
)
